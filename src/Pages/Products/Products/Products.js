                    ...
                    <div key={product._id} className="bg-white w-10/12 rounded-md shadow-lg flex flex-col lg:flex-row">
                        ...
                        <div className='w-full lg:w-3/4 p-4 flex flex-col lg:flex-row justify-between'>
                            <div>
                                ...
                                <p className='text-sm font-semibold mb-1 flex items-center'>Seller: {product.sellerName} <BsCheckCircleFill className='ml-1 text-md text-blue-600'/></p>
                            ...
                            <div className='flex mt-5 lg:mt-0 lg:flex-col justify-between'>
                                <button className="btn btn-sm btn-primary text-white">Add to wishlist</button>
                                <button className="btn btn-sm btn-secondary text-white">Book Now</button>
                            </div>
                        </div>
                    </div>)
                }
